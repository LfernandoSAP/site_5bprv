    ...
    <div class="lg:col-span-1">
        <div class="admin-card p-4">
            ...
            <div class="space-y-2">
                ...
                <a href="{{ ag('pages') }}" class="block w-full px-4 py-3 text-center border border-[#101010]/18 text-[#101010] rounded-xl hover:bg-[#101010] hover:text-white transition">Cancelar</a>
            </div>
        </div>
    </div>
</div>
